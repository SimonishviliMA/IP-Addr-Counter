...
class IPv4BlockingQueue {
     ...
     */
    protected IPv4BlockingQueue(int maxCapacity, int delta) {
     ...
     */
    protected void put(long ip) throws InterruptedException {
     ...
     */
    protected long take() throws InterruptedException {
